    ...
    <div class="h-screen bg-[#0f0f0f] text-white flex flex-col">
        ...
        <div class="flex-1 flex">
            <div class="flex-1 flex flex-col relative">
                ...
                <div
                    class="flex-1 overflow-y-auto px-5 md:px-10 pt-6 pb-24 md:pb-10 space-y-10 max-w-4xl mx-auto w-full"
                >
                    <div v-if="workouts.length > 0" class="space-y-3">
                        ...
                        >
                            ...
                            <div
                                class="flex items-center gap-3 mt-3 text-sm text-gray-400"
                            >
                                <div class="flex items-center gap-1">
                                    <span
                                        class="text-[#7ED957] font-semibold"
                                        >{{ w.exercises }}</span
                                    >
                                    <span>ex</span>
                                </div>
