...
<template>
    <div class="h-full bg-[#080808] text-white flex flex-col overflow-hidden">
        ...
        <div class="flex-1 overflow-y-auto px-8 py-6 space-y-6">
            ...
            <div
                class="bg-[#111] border border-white/5 rounded-2xl p-5 space-y-4"
            >
                <p class="text-xs text-gray-500 uppercase tracking-wider">
                ...
                <div class="grid grid-cols-3 gap-3">
                    <div
                        class="bg-[#0a0a0a] rounded-2xl p-4 border border-white/5"
                    >
                        <p class="text-xs text-gray-500 mb-1">Active</p>
                        <p class="text-2xl font-bold text-[#7ED957]">
                            {{
                        ...
                        <p class="text-xs text-gray-600 mt-1">paying now</p>
                    </div>
                    <div
                        class="bg-[#0a0a0a] rounded-2xl p-4 border border-white/5"
                    >
                    ...
                    <div
                        class="bg-[#0a0a0a] rounded-2xl p-4 border border-white/5"
                    >
                        <p class="text-xs text-gray-500 mb-1">Canceled</p>
                ...
                <div
                    class="bg-[#0a0a0a] rounded-2xl p-4 border border-white/5 space-y-2"
                >
                    ...
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-500"
                            >Potential (incl. trials)</span
                        >
                        <span class="text-white font-bold"
                            >${{
                                (
                                    activeSubscriptions.length * PRICE_PER_MONTH
                                ).toFixed(2)
                            }}</span
                        >
                    </div>
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-500"
                            >Price per subscription</span
                        >
                        <span class="text-white font-bold"
                            >${{ PRICE_PER_MONTH }}/mo</span
                        >
                    </div>
                    <div class="flex justify-between text-sm">
